...
class ACF_Assets {
	...
	public function register_scripts() {
		...
		wp_register_script( 'acf', plugin_dir_url(__FILE__) . '/../../assets/js/acf' . $suffix . '.js' , array( 'jquery' ), $version );
        ...
        wp_register_script( 'acf-input', plugin_dir_url(__FILE__) . '/../../assets/js/acf-input' . $suffix . '.js' , array( 'jquery', 'jquery-ui-sortable', 'jquery-ui-resizable', 'acf' ), $version );
		
        //wp_register_script( 'acf-field-group', acf_get_url( 'assets/js/acf-field-group' . $suffix . '.js' ), array( 'acf-input' ), $version );
		wp_register_script( 'acf-field-group', plugin_dir_url(__FILE__) . '/../../assets/js/acf-field-group' . $suffix . '.js' , array( 'acf-input' ), $version );
		
		// Register styles.
		//wp_register_style( 'acf-global', acf_get_url( 'assets/css/acf-global.css' ), array(), $version );
		wp_register_style( 'acf-global', plugin_dir_url(__FILE__) . '/../../assets/css/acf-global.css' , array(), $version );
		
        //wp_register_style( 'acf-input', acf_get_url( 'assets/css/acf-input.css' ), array('acf-global'), $version );
		wp_register_style( 'acf-input', plugin_dir_url(__FILE__) . '/../../assets/css/acf-input.css' , array('acf-global'), $version );
		
        //wp_register_style( 'acf-field-group', acf_get_url( 'assets/css/acf-field-group.css' ), array('acf-input'), $version );
		wp_register_style( 'acf-field-group', plugin_dir_url(__FILE__) . '/../../assets/css/acf-field-group.css' , array('acf-input'), $version );
